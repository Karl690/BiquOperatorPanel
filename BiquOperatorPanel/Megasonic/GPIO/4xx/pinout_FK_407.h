...
//B motor definitions
#define HeartBeat_Pin       (PIN_PORT_C | PIN_NUM_13 | PIN_INIT_LOW | OUTPUT_PP_50MHZ)
#define HeartBeat_Set       GPIOC->BSRR = PIN_MASK_13                 //index to the set bit register
#define HeartBeat_Clr       GPIOC->BSRR = (uint32_t)PIN_MASK_13 << 16 //index to the Clear bit register
...
//#define PnP_Clear_Set       GPIOD->BSRRL = PIN_MASK_05                 //index to the set bit register
//#define PnP_Clear_Clr       GPIOD->BSRRH = PIN_MASK_05  //index to the Clear bit register
...
#define SPI2_LCD_RS				(PIN_PORT_C | PIN_NUM_02 | PIN_INIT_HIGH | OUTPUT_PP_50MHZ)
#define SPI2_LCD_CS				(PIN_PORT_B | PIN_NUM_07 | PIN_INIT_HIGH | OUTPUT_PP_50MHZ)
#define SPI2_LCD_MOSI			(PIN_PORT_C | PIN_NUM_03 | PIN_AF_SPI2)
#define SPI2_LCD_SCK			(PIN_PORT_B | PIN_NUM_10 | PIN_AF_SPI2)
//onboard flat ribbon display
...
//#define SPI3_LCD_CS				(PIN_PORT_E | PIN_NUM_02 | PIN_INIT_HIGH | OUTPUT_PP_50MHZ)
//#define SPI3_LCD_MOSI			(PIN_PORT_C | PIN_NUM_12 | PIN_AF_SPI3)
//#define SPI3_LCD_SCK			(PIN_PORT_C | PIN_NUM_10 | PIN_AF_SPI3)
//extern display j29 on 102207 pcb

#define SPI3_LCD_RS				(PIN_PORT_C | PIN_NUM_11 | PIN_INIT_HIGH | OUTPUT_PP_50MHZ)
#define SPI3_LCD_MOSI			(PIN_PORT_C | PIN_NUM_12 | PIN_AF_SPI3)
#define SPI3_LCD_SCK			(PIN_PORT_C | PIN_NUM_10 | PIN_AF_SPI3)
//comment out the following lines if you are on spine Aux 2 connector
...
//
//#define SPI3_LCD_CS				(PIN_PORT_C | PIN_NUM_00 | PIN_INIT_HIGH | OUTPUT_PP_50MHZ)
//#define SPI3_LCD_RST			(PIN_PORT_C | PIN_NUM_09 | PIN_INIT_HIGH | OUTPUT_PP_50MHZ)
//
