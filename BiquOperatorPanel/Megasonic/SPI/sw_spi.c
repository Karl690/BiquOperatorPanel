...
#define SCK_HIGH()    GPIO_SetLevel(sw_spi->sck, 1); //HAL_Delay(20)  // The speed of xpt2046 should not be too fast
#define SCK_LOW()     GPIO_SetLevel(sw_spi->sck, 0); //HAL_Delay(20)  // It is better to be below 200KHz.
