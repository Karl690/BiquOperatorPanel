...
LcdVariableInfo CMDQueValues[] = {
	{(uint32_t)&QueDisplayIndex,            "CmdQue  ", FUNC_INT16,	COLOR_WHITE,	COLOR_MAGENTA, 	0},          ///Offset
...
LcdVariableInfo FaultValueTable[] = {
	...
	{(uint32_t)&faultVariableInfo.TaskSliceNumber,    "TaskSlicNum", FUNC_INT32, 	COLOR_WHITE,	COLOR_LIME, 		0},
	{(uint32_t)&faultVariableInfo.NumberOfFaults,     "NumOfFaults", FUNC_INT16, 	COLOR_WHITE,	COLOR_LIME, 		0},
	{(uint32_t)&faultVariableInfo.GcodeLineCounter,   "GcodeLines ", FUNC_INT16, 	COLOR_WHITE,	COLOR_LIME, 		0},
	{(uint32_t)&faultVariableInfo.ParsedLineCounter,  "ParsedLines", FUNC_INT16, 	COLOR_WHITE,	COLOR_LIME, 		0},
	...
	{(uint32_t)&faultVariableInfo.LastCharsInBuf,     "CharsInBuf ", FUNC_INT32, 	COLOR_WHITE,	COLOR_LIME, 		0},
